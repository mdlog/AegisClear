...
LIMIT_S = 172.0
CUT_LIST = [
    'Beat 7: drop "There is no owner, pause or proxy on the money path, and settling is permissionless."',
    'Beat 2: drop "The terms go to the client alone." (and its hover)',
    'Beat 1: drop ", on a trusted evaluator\'s word"',
    'Beat 9: drop the beat; the rollover stays in the README and the runbook',
]
