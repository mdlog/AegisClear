...
OUT = VIDEO / "out"
PUBLIC_HOST = "localhost:4040"  # the console is local by design: its demo keys never leave the server
...
# BorderStyle 3 boxes are drawn in OutlineColour, padded by Outline px (libass): ink #15201B at ~70 %.
HEADER = """[Script Info]
ScriptType: v4.00+
PlayResX: 1920
PlayResY: 1080
...
Style: Cap,Inter,40,&H00FFFFFF,&H00FFFFFF,&H4C1B2015,&H00000000,0,0,0,0,100,100,0,0,3,14,0,2,200,200,56,1
Style: Chip,DejaVu Sans Mono,24,&H00FFFFFF,&H00FFFFFF,&H601B2015,&H00000000,0,0,0,0,100,100,0,0,3,8,0,3,0,36,30,1
...
def main():
    ...
    for row in audio:
        ...
        for i, r in enumerate(routes):
            ...
            label = re.sub(r"(0x[0-9a-fA-F]{4})[0-9a-fA-F]{24,}([0-9a-fA-F]{4})", r"\1…\2", label)  # addresses and hashes as the console prints them
